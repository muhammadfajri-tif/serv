...
int main(int argc, char *argv[]) {
  ...
  close(sockfd); // no need listener, so we can close socket file descriptor

  // INFO: Step 5.1: Send message
  ...
  printf("[INFO] Number of bytes sent: %d\n", bytes_sent);
